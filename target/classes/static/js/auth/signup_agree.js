...
function buttonAgreeNext() {
    if((Site01.checked || Site02.checked || Site03.checked)&&(Agree01.checked && Agree02.checked && Agree03.checked) == true)
    {
        buttonAgree.onclick = location.href("auth/signup/step2");
    }else{
